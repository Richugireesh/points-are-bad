...
_MEETING = [{"meeting_key": 1234, "meeting_name": "Australian Grand Prix", "country_name": "Australia", "location": "Melbourne"}]
...
_DRIVERS = [
    {"driver_number": "1", "broadcast_name": "M VERSTAPPEN", "first_name": "Max", "last_name": "Verstappen", "name_acronym": "VER"},
    {"driver_number": "4", "broadcast_name": "L NORRIS", "first_name": "Lando", "last_name": "Norris", "name_acronym": "NOR"},
]
...
class TestFetchOpenF1Results:
    ...
    def test_returns_none_when_no_matching_meeting(self):
        other_meeting = [{"meeting_key": 1, "meeting_name": "Bahrain GP", "country_name": "Bahrain", "location": "Sakhir"}]
    ...
    def test_matches_by_country_name_fallback(self):
        ...
        country_meeting = [{"meeting_key": 1234, "meeting_name": "Round 3", "country_name": "Australia", "location": "Melbourne"}]
    ...
    def test_matches_by_location_fallback(self):
        ...
        location_meeting = [{"meeting_key": 1234, "meeting_name": "Round 3", "country_name": "AUS", "location": "Melbourne"}]
    ...
    def test_driver_fallback_when_no_name(self):
        nameless_driver = [{"driver_number": "1", "broadcast_name": None, "first_name": None, "last_name": None, "name_acronym": ""}]
...
class TestGetScheduleUpdates:
    ...
    def test_skips_events_with_no_name(self, monkeypatch):
        ...
        schedule = pd.DataFrame([
            {"EventName": None, "EventDate": pd.Timestamp("2026-02-15"), "EventFormat": "testing"},
            {"EventName": "Bahrain Grand Prix", "EventDate": pd.Timestamp("2026-03-01"), "EventFormat": "conventional"},
        ])
    ...
    def test_returns_new_races_and_date_updates(self, monkeypatch):
        ...
        schedule = pd.DataFrame([
            {"EventName": "Bahrain Grand Prix", "EventDate": pd.Timestamp("2026-03-01"), "EventFormat": "conventional"},
            {"EventName": "Saudi Arabian Grand Prix", "EventDate": pd.Timestamp("2026-03-09"), "EventFormat": "conventional"},
        ])
        # Filter removes testing events
        mock_fastf1 = MagicMock()
        mock_fastf1.get_event_schedule.return_value = schedule
        mock_fastf1.Cache.enable_cache = MagicMock()
        ...
        existing = [{"name": "Bahrain Grand Prix", "date": "", "actual_results": [], "predictions": {}}]
